...
{	
	...
	switch (id)
	{
		...
		case 2:
		{
			cout<<"NAME - DR. JAKIR HUSSAIN"<<endl;
			cout<<"SEX - MALE"<<endl;
		...
		case 5:
		{
			cout<<"NAME - DR. NITIN AGARWAL "<<endl;
			cout<<"SEX - MALE"<<endl;
